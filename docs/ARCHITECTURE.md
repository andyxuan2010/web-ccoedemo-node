...
```text
https://web-platform-eastus-dev-node.azurewebsites.net/auth/callback?code=0.A...&state=ab12cd34ef56...
```
...
1. Check the configured App Service targets:
   - primary: `web-platform-eastus-dev-node`
   - secondary: `web-nateams-dev-node-601`
   - third: `web-ccoedemo-dev-node-602`
